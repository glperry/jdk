...
public final class String
    ...
    /**
     * 通常Object的equals方法底层是调用 obj==anoObj即对象实例在堆内存中的指针指向是否指向同一个.
     * String的equals(),重写了Object的equals:
     * 1,如果对象在堆内存中指向相同,则返回true
     * 2,如果String的值对应的ASCII码表中对应的数值 都相等,同样返回true.
     */
